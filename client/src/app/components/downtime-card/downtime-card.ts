...
@Component({
  ...
  template: `
    <div
      class="w-full h-full border border-gray-300 dark:border-gray-700 rounded overflow-hidden shadow-lg animate-fadeIn flex bg-white dark:bg-gray-800"
    >
      <!-- Current Downtime -->
      <div
        class="w-1/2 p-6 text-center border-r border-gray-300 dark:border-gray-700"
      >
        <div
